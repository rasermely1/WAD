...
function Sidebar() {
    ...
    return (
        <div className="flex sticky h-screen grid grid-rows-12 col-span-1 bg-purple-700">
            <div className="row-span-2 flex justify-center items-center text-3xl font-mono">
                <Link href="/">
                    <img src="/resources/LSU-white.png" alt="LSU" className="size-25 px-12" />
                </Link>
            </div>

            <div className="flex grid grid-rows-8 row-span-5">
                <hr className="mx-9 border-gray-200" />
                ...
                {[
                    ...
                    <div className="grid grid-cols-12" key={index}>
                        ...
                        ></div>
                        <div
                            className={`flex items-center ms-6 font-mono col-span-11 ${
            ...
            <div className="row-span-3 grid grid-rows-5">
                <hr className="row-span-1 border-gray-200 mx-9"></hr>
                <div className="row-span-1 font-mono text-sm text-white hover:text-purple-300 ms-12"><Link href="https://discord.gg/st8Hh6Ny">WAD Discord</Link></div>
                <div className="row-span-1 font-mono text-sm text-white hover:text-purple-300 ms-12"><Link href="https://tigerlink.lsu.edu/WAD/club_signup">Get Involved</Link></div>
                <div className="row-span-1 font-mono text-sm text-white hover:text-purple-300 ms-12"><Link href="/about">About WAD</Link></div>
            </div>
